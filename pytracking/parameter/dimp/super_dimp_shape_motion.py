...
def parameters():
    ...
    # Motion parameters
    params.use_motion=True
    params.visualizationSEKD=False
    params.visualizationmotionguide=False
    params.centermax=False
    params.checkmotion=False
    params.duration=20
    params.motiondistractor_threshold=0.85
    params.ship=5
    params.checkoutput=5
    params.checkoffset=5
    params.net = NetWithBackbone(net_path='super_dimp_shape.pth.tar',
